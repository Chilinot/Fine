...
describe "lexer" do
    ...
    it "parser/p06.c" do
        expect(parse("parser/p06.c").inspect).to eq "#<struct Program nodes=[#<struct FunctionDeclaration type=:VOID, name=\"f\", formals=[], body=#<struct FunctionBody declarations=[], statments=[#<struct Return expr=nil>]>>, #<struct FunctionDeclaration type=:INT, name=\"g\", formals=[], body=#<struct FunctionBody declarations=[], statments=[#<struct Return expr=#<struct Constant type=:INT, value=42>>]>>, #<struct FunctionDeclaration type=:INT, name=\"main\", formals=[], body=#<struct FunctionBody declarations=[], statments=[#<struct FunctionCall name=\"f\", args=[]>, #<struct FunctionCall name=\"g\", args=[]>]>>]>"
    end
    it "parser/p07.c" do
