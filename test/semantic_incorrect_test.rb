...
describe "semantic analysis" do
    ...
    it "semantic/se04.c" do
        expect(semantic_error_message("semantic/se04.c")).to eq "Semantic error: a already defined"
    end
    it "semantic/se05.c" do
        expect(semantic_error_message("semantic/se05.c")).to eq "Semantic error: a already defined"
    end
    it "semantic/se06.c" do
        expect(semantic_error_message("semantic/se06.c")).to eq "Semantic error: a already defined"
    end
    ...
    it "semantic/se11.c" do
        expect(semantic_error_message("semantic/se11.c")).to eq "Semantic error: can not assign to function"
    end
    ...
    it "semantic/se13.c" do
        expect(semantic_error_message("semantic/se13.c")).to eq "Semantic error: int + void is not defined"
    end
    ...
    it "semantic/se19.c" do
        expect(semantic_error_message("semantic/se19.c")).to eq "Semantic error: char_array == int is not defined"
    end
    it "semantic/se20.c" do
        expect(semantic_error_message("semantic/se20.c")).to eq "Semantic error: reference to int-array can not be modified"
    end
end
